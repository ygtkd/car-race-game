...
static class FlowTests {
 ...
 public static void Run(){
  foreach(var id in new[]{"ridge","suzuka"}){
   ...
   Simulation.StepCar(safe,new DriveInput(),t,.02f);float last=safe.safeDistance;safe.x+=tangent.z*10;safe.z-=tangent.x*10;
   ...
   var a=new CarState{finished=true,finishTime=100,elapsed=100,id="human"};var b=new CarState{bot=true,id="bot1",elapsed=100};var d=new CarState{bot=true,id="bot2",index=300,elapsed=100};
