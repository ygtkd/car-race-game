...
{
 Properties { _Color("Color",Color)=(1,1,1,1) _Metallic("Metallic",Range(0,1))=0 _Smoothness("Smoothness",Range(0,1))=.2 _Grain("Grain",Range(0,1))=0 }
 SubShader {
 ...
 float diffuse=max(0,dot(n,l));float3 h=normalize(l+v);
