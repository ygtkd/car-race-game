...
namespace CoastRacer.Core {
 ...
 public static class SpecialPower {
  public const float Gain=5,Duration=5,BoostAcceleration=1+.70f*Gain,CadenceAcceleration=1+.60f*Gain,FeastAcceleration=1+.40f*Gain,GripAcceleration=1+.24f*Gain,BoostSpeed=1+.24f*Gain,Grip=1+.60f*Gain,ShieldMass=1+1.60f*Gain,PulseRadius=20,PulseDrag=4*Gain;
