...
let first;try{
 ...
 assert(errors.length===0,'No browser runtime errors');fs.writeFileSync('Logs/revision3-browser-checks.json',JSON.stringify({checks,errors,note:'Desktop Edge touch emulation; gauge check uses steering assist along road after repeated manual input cycles.'},null,2));
